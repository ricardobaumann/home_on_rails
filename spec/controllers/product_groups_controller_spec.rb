...
RSpec.describe ProductGroupsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all product_groups as @product_groups" do
      ...
      expect(assigns(:product_groups)).to eq([product_group])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new product_group as @product_group" do
      ...
      expect(assigns(:product_group)).to be_a_new(ProductGroup)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created product_group as @product_group" do
        post :create, {:product_group => valid_attributes}, valid_session
        expect(assigns(:product_group)).to be_a(ProductGroup)
        expect(assigns(:product_group)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved product_group as @product_group" do
        post :create, {:product_group => invalid_attributes}, valid_session
        expect(assigns(:product_group)).to be_a_new(ProductGroup)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested product_group" do
        product_group = ProductGroup.create! valid_attributes
        put :update, {:id => product_group.to_param, :product_group => new_attributes}, valid_session
        product_group.reload
        expect(product_group.name).to eq(new_attributes[:name])
      end
    ...
    context "with invalid params" do
      it "assigns the product_group as @product_group" do
        product_group = ProductGroup.create! valid_attributes
        put :update, {:id => product_group.to_param, :product_group => invalid_attributes}, valid_session
        expect(assigns(:product_group)).to eq(product_group)
      end
